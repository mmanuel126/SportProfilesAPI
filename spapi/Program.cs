...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Sport Profiles API",
        Description = "RESTful API web service for the Sport Profiles (SP) social networking application." +
        "<br/><br/>Author: <b>Marc Manuel</b><br/><br/>Email: <b>marcmanmedia@gmail.com</b> ",
        Version = "v1"
    });
...
app.UseSwaggerUI(c =>
{
    ...
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Sport Profiles API V1");
});
